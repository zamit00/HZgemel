 ...
 // קורא נתונים מקובץ    
       fetch('data.txt')
          ...
          let fields = item.split(',');              
           if (y===x){
            if (fields[4] && fields[3] && fields[5] && fields[41] && fields[43] && fields[33] && fields[45] ){
                  if (fields[4].includes("מגדל מקפת") && fields[3].includes(x) && item.includes(y) && fields[41]>= safDown1
          ...
          if (y === "אקטיבי") {
            ...
            if (fields[4] && fields[3] && fields[5] && fields[41] && fields[43] && fields[45] && fields[33]){
                if (fields[4].includes("מגדל מקפת") && fields[3].includes(x) && actionsA.some(action => fields[5].includes(action)) && fields[41]>= safDown1
                   && fields[41]< safUp1  && fields[43]>= safDown2 && fields[43]< safUp2  && fields[33]>= safDown3
                   && fields[33]< safUp3  && fields[45]>= safDown4 && fields[45]< safUp4) {
                addOption(fields[1], fields[2],fields[9]);
                }
          ...
          if (y==="פאסיבי"){ 
              ...
              if (fields[4] && fields[3] && fields[5] && fields[41] && fields[43] && fields[45] && fields[33]){
                  if (fields[4].includes("מגדל מקפת") && fields[3].includes(x) && actionsP.some(action => fields[5].includes(action)) && fields[41]>= safDown1
                   && fields[41]< safUp1  && fields[43]>= safDown2 && fields[43]< safUp2  && fields[33]>= safDown3
                   && fields[33]< safUp3  && fields[45]>= safDown4 && fields[45]< safUp4) {
                addOption(fields[1], fields[2],fields[9]);
                 }  
          ...
          if (y==="קיימות"){
              if (fields[4] && fields[3] && fields[5] && fields[41] && fields[43] && fields[45] && fields[33]){
                  if (fields[4].includes("מגדל מקפת") && fields[3].includes(x) && fields[5].includes(act9) && fields[41]>= safDown1
                   && fields[41]< safUp1  && fields[43]>= safDown2 && fields[43]< safUp2  && fields[33]>= safDown3
                   && fields[33]< safUp3  && fields[45]>= safDown4 && fields[45]< safUp4 ) {
                  addOption(fields[1], fields[2],fields[9]);
                 }  
          ...
          if (y==="הלכתי"){
              if (fields[4] && fields[3] && fields[5] && fields[41] && fields[43] && fields[45] && fields[33]){
                  if (fields[4].includes("מגדל מקפת") && fields[3].includes(x) && fields[5].includes(act10) && fields[41]>= safDown1
                   && fields[41]< safUp1  && fields[43]>= safDown2 && fields[43]< safUp2  && fields[33]>= safDown3
                   && fields[33]< safUp3  && fields[45]>= safDown4 && fields[45]< safUp4) {
                  addOption(fields[1], fields[2],fields[9]);
                 }  
